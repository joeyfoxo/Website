        ...
        <section id="past-projects" className="past-projects">
            <div className="container">
                <div className="section-title-resume">
                    <Typography variant="h4" component="h2" sx={{ color: theme.palette.primary.main }}>
                        Personal Projects
                    </Typography>
                </div>
                ...
                >
                    ...
                    {/* KeeleMC project box */}
                    <div className="project-box keelemc-box">
                    ...
                    {/* Remote Access Trojan project box */}
                    <div className="project-box">
